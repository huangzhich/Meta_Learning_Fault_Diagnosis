...
def parse_args():
    ...
    parser.add_argument('--base_data_path', default='/content/drive/MyDrive/Colab Notebooks/data_disk/dataset/FD/bearing_data/2048', help='base path keeping image data')

    parser.add_argument('--source_dataset', default='dataset_0', help='dataset_0/1/2/3')
    parser.add_argument('--target_dataset', default='dataset_3', help='dataset_0/1/2/3')
    ...
    parser.add_argument('--base_logdir', default='/content/drive/MyDrive/Colab Notebooks/data_disk/deeplearning/few-shot-learning-FD-bearing-diff-load/exp_logs/', help='folder to keep all running files')
    parser.add_argument('--method', default='matching_network_feat_space', help='finetune_last/finetune_whole/feature_knn/matching_network/matching_network_feat_space/matching_network_pretrain')

    # few-shot task setting
    parser.add_argument('--train_n_way', default=10, type=int, help='class num to classify for training')
    parser.add_argument('--test_n_way', default=10, type=int, help='class num to classify for testing (validation) ')
    parser.add_argument('--n_shot', default=1, type=int, help='number of labeled support data in each class')
    ...
    parser.add_argument('--pretrain_source_num_classes', default=10, type=int, help='total number of classes')
    parser.add_argument('--pretrain_target_num_classes', default=10, type=int, help='total number of classes')
